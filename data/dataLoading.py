...
class MNIST_test(Dataset):
    def __init__(self):
        ...
        self.dataset = datasets.FashionMNIST(root='./data', train=False, download=True, transform=transform)
...
class MNIST_train(Dataset):
    def __init__(self, numGroups=5, valSplit=0):
        ...
        self.dataset = datasets.FashionMNIST(root='./data', train=True, download=True, transform=transform)
